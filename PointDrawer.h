...
public:
  ...
  void SetTextureHeight(unsigned int texh){imgHeight = texh;}
  void SetTextureWidth(unsigned int texw){imgWidth = texw;}
  void DrawImage(float x, float y, float z) const;
